    ...
    <>
      <section className="w-full min-h-[50dvh] min-w-full prose prose-lg md:prose-xl px-1">
        ...
        <p>
          ...
          the destitute, and the abandoned. It&apos;s a place where the
          physical, mental, emotional, and spiritual needs of the most
          vulnerable are met with the highest level of care. Education is a
          cornerstone, offering every child the hope and opportunity for a
          bright future.
        </p>
        <p>
        ...
        <p>
          Farooqi Orphanage is dedicated to providing a holistic approach to
          care. It aims to address not only the mental needs of children but
          also to offer a complete package that nurtures their physical,
          spiritual, and emotional well-being. The ultimate goal is to replicate
          such communities globally, offering a beacon of hope and support to
        ...
        <p>
          ...
          various reasons. These can range from the loss of parents, abuse,
          mental illness in the family, or economic circumstances that prevent
          parents from caring for their children. The legal responsibility for
          supporting these children varies across countries, but the underlying
          principle remains the same: to provide a safe and caring environment
          for children who need it the most. Farooqui Orphanage stands as a
          testament to this principle, striving to make a difference in the
          lives of children and the community at large.
        </p>
